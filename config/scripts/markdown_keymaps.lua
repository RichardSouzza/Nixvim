function()
  ...
  vim.keymap.set("n", "<C-i>",  [[a**<Esc>i ]],         { buffer = true, desc = "Insert *italic*"                     })
  ...
  vim.keymap.set("n", "<C-n>",  [[I1. ]],               { buffer = true, desc = "Insert numbered list"                })
  ...
  vim.keymap.set("i", "<C-i>",  [[**<Esc>i ]],          { buffer = true, desc = "Insert *italic*"                     })
  ...
  vim.keymap.set("i", "<C-n>",  [[1. ]],                { buffer = true, desc = "Insert numbered list"                })
